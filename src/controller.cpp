...
std::list<std::string> Skudar::Controller::modulateWork(Analytics &analytics)
{
    ...
    Skudar::Source *sources = new Skudar::Source(alpha, beta, sourcesAmount);
    Skudar::Buffer *buffers = new Skudar::Buffer(buffersAmount);
    Skudar::Device *devices = new Skudar::Device(devicesAmount, lambda);
...
void Skudar::Controller::setDevicesAmount(int value)
{
    devicesAmount = value;
}

void Skudar::Controller::setRequestsNumber(int value)
{
    requestsNumber = value;
}

void Skudar::Controller::setBuffersAmount(int value)
{
    buffersAmount = value;
}

void Skudar::Controller::setSourcesAmount(int value)
{
    sourcesAmount = value;
}

void Skudar::Controller::setLambda(float value)
{
    lambda = value;
}

void Skudar::Controller::setBeta(float value)
{
    beta = value;
}

void Skudar::Controller::setAlpha(float value)
{
    alpha = value;
}

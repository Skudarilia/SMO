...
void Skudar::Analytics::addRequestToBuff(Skudar::Request request, int buff)
{
    analytics.push_back(std::make_pair(std::make_pair(request, buff), ADD_TO_BUFF));
}

void Skudar::Analytics::removeRequestFromBuff(Skudar::Request request, int buff)
{
    analytics.push_back(std::make_pair(std::make_pair(request, buff), REMOVE_FROM_BUFF));
}

void Skudar::Analytics::getRequestFromBuff(Skudar::Request request, int buff)
{
    analytics.push_back(std::make_pair(std::make_pair(request, buff), GET_FROM_BUFF));
}

void Skudar::Analytics::addRequestToDevice(Skudar::Request request, int device)
{
    analytics.push_back(std::make_pair(std::make_pair(request, device), ADD_TO_DEVICE));
}

void Skudar::Analytics::removeRequestFromDevice(Skudar::Request request, int device)
{
    analytics.push_back(std::make_pair(std::make_pair(request, device), REMOVE_FROM_DEVICE));
}

void Skudar::Analytics::beginTransaction()
{
    sourcesAmount = 0;
    buffersAmount = 0;
    devicesAmount = 0;
...
bool Skudar::Analytics::config(int sourcesAmount, int buffersAmount, int devicesAmount)
{
...
void Skudar::Analytics::commit(float allWorkTime)
{
...
std::vector<Skudar::Analytics::StepModel> Skudar::Analytics::getSteps() const
{
    return steps;
}

int Skudar::Analytics::getLinesAmount() const
{
    return sourcesAmount + buffersAmount + devicesAmount;
}

int Skudar::Analytics::getDevicesAmount() const
{
    return devicesAmount;
}

int Skudar::Analytics::getBuffersAmount() const
{
    return buffersAmount;
}

int Skudar::Analytics::getSourcesAmount() const
{
    return sourcesAmount;
}

std::vector<float> Skudar::Analytics::getDeviceLoad() const
{
    return deviceLoad;
}

std::vector<float> Skudar::Analytics::getProb_of_fail() const
{
    return prob_of_fail;
}

std::vector<float> Skudar::Analytics::getDisp_top() const
{
    return disp_top;
}

std::vector<float> Skudar::Analytics::getDisp_tow() const
{
    return disp_tow;
}

std::vector<float> Skudar::Analytics::getTime_of_process() const
{
    return time_of_process;
}

std::vector<float> Skudar::Analytics::getTime_of_wait() const
{
    return time_of_wait;
}

std::vector<float> Skudar::Analytics::getTime_in_system() const
{
    return time_in_system;
}

std::vector<int> Skudar::Analytics::getReq_fail() const
{
    return req_fail;
}

std::vector<int> Skudar::Analytics::getReq_proc() const
{
    return req_proc;
}
